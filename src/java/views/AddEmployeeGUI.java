...
public class AddEmployeeGUI extends JFrame {
    ...
    public AddEmployeeGUI() {
        ...
        btnAddEmployee.setBounds(587, 444, 282, 55);
...
//	private JTextField txtSalary;
    ...
    public void addEmployeeBtnClicked() {
        if (isTextFieldsValid()) {
            Employee newEmployee = new Employee(0, txtFname.getText(),
                    txtLname.getText(),
                    txtPhone.getText(),
                    txtEmail.getText(),
            ...
            JOptionPane.showMessageDialog(lblAddSuccess, "New employee added successfully.");
        }
    }
